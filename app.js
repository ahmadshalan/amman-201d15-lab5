...
single argument and then returns an array where the first element is the sum of the numbers 
in the array, and the second element is a string that EXACTLY follows this example and uses 
the values that were input into the function:

"2,3,4 was passed in as an array of numbers, and 9 is their sum."

IMPORTANT DETAIL: You may not use the arithmetic operator + in this function. To do addition, use your 
sum() function that you've already created. You're going to have to be resourceful to figure out how to do this.
...
function sumArray(sumArr) {
  ...
  let sum0=sum(testArray[0],testArray[1]);
  sum0=sum(sum0[0],testArray[2]);
  console.log(sum0);

  return[sum0[0],`2,3,4 was passed in as an array of numbers, and ${sum0[0]} is their sum.`]
...
function multiplyArray(multArr) {
  ...
  let mult0=multiply(testArray[0],testArray[1]);

  mult0=multiply(mult0[0],testArray[2]);

  console.log(mult0[0]);

  return[mult0[0],`The numbers 2,3,4 have a product of ${mult0[0]}.`]
...
You're going to have to be resourceful to figure out how to do this. However, you may
...
function multiplyAnyArray(dynamicArray) {
  ...
  let mult1= multiply(testDynamicArray[0],testDynamicArray[1]);

  mult1=multiply(mult1[0],testDynamicArray[2]);

  mult1=multiply(mult1[0],testDynamicArray[3]);
  mult1=multiply(mult1[0],testDynamicArray[4]);

  console.log(mult1[0]);

  return[mult1[0],`The numbers 1,2,3,4,5 have a product of ${mult1[0]}.`]
